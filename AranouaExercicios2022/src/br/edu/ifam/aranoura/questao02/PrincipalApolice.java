package br.edu.ifam.aranoura.questao02;
import br.edu.ifam.aranoura.questao01.*;
...
public class PrincipalApolice {
	...
	public static void main(String[] args) {
		...
		apolice5.imprimir(apolice5.getNomeSegurado(),apolice5.getIdade(),apolice5.getValorPremio());
		apolice5.calcularValorPremio(apolice5);
